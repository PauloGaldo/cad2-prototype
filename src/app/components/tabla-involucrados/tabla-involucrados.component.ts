...
@Component({
  selector: 'cad-tabla-involucrados',
  templateUrl: './tabla-involucrados.component.html',
  styleUrls: ['./tabla-involucrados.component.scss']
})
export class TablaInvolucradosComponent implements AfterViewInit {
